<template>
  <div id="stereo-panner-node">
    <h1 class="text-3xl font-bold text-center my-8 dark:text-white">Stereo Panner Node</h1>
    ...
    <div id="config">
      ...
      <div class="audio-note">
        ...
        <div class="item">
          ...
          <input type="range" min="-1" max="1" step="0.01" id="pan" v-model="pan" @input="changeHandler" class="accent-primary">
        </div>
      </div>
    </div>
  </div>
